      ...
      <Card>
        <CardContent className="p-6">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">3. Настройте генерацию (опционально)</h3>
            
            <div>
              <Label htmlFor="custom-prompt">Дополнительные инструкции для AI</Label>
              <Textarea
                id="custom-prompt"
            ...
            <Button 
              ...
              disabled={isGenerating || !uploadedImage || selectedClothingItems.length === 0}
              className="w-full"
              size="lg"
            >
              {isGenerating ? (
