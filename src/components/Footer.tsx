        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              Онлайн-сервисы для вашего образа и самопознания: виртуальная примерка одежды, определение цветотипа и типажа, стилевой анализ внешности, подбор образов, ароматов и подарков. Находите то, что подчёркивает вашу природную красоту.
            </p>
          </div>
