                    ...
                    <div className="flex items-center justify-between text-xs text-muted-foreground">
                      <div>
                        <Icon
                          ...
                          size={12}
                        />
                        Если промпт (задание на генерацию картинки) будет
                        слишком большой, есть вероятность, что
          ...
          <div className="max-w-5xl mx-auto mt-16 mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Примеряйте до 10 вещей за раз: одежду, обувь, сумки, аксессуары и украшения. Добавляйте вещи из каталога на сайте, по ссылке на товар Wildberries, своим фото или просто описав вещь текстом. Как получить ссылку на товар — смотрите в разделе «Часто задаваемые вопросы».
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 bg-purple-100 rounded-full flex items-center justify-center">
                ...
                <Accordion type="single" collapsible className="w-full">
                  ...
                  <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                      ...
                      можете добавлять промпты (задания на генерацию картинки)
                      для изменения фона и стиля.
                    </AccordionContent>
                  </AccordionItem>
