    ...
    <Layout>
      ...
      <div className="mx-auto max-w-6xl px-1 py-10 sm:px-6">
        <div className="mb-8 text-center">
          ...
          {/* Не все знают, что расклад можно не только вытянуть на сайте,
              но и ввести свой — с реальной колоды */}
          <p className={`mt-1 text-sm ${divTheme.muted}`}>
            Толкуем и карты, вытянутые онлайн на сайте, и те, что вы разложили
            сами — реальной колодой
          </p>
        </div>
