  ...
  const services = [
    {
      ...
      image: 'https://cdn.poehali.dev/projects/ae951cd8-f121-4577-8ee7-ada3d70ee89c/bucket/GJWVtxi5yZFluCrTBy2RO.png',
      icon: 'Shirt',
      path: '/virtualfitting',
    },
    {
      ...
      image: 'https://cdn.poehali.dev/projects/ae951cd8-f121-4577-8ee7-ada3d70ee89c/bucket/2W537Cj3JxTEqLHWMrUh1.png',
      icon: 'Palette',
      path: '/colortype',
    },
  ];
