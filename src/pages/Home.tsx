  ...
  const services = [
    {
      ...
      image: 'https://cdn.poehali.dev/projects/ae951cd8-f121-4577-8ee7-ada3d70ee89c/bucket/AFOzmM93nFTwxvTxlbpUm.png',
      icon: 'Shirt',
      path: '/virtualfitting',
    },
    {
      ...
      image: 'https://cdn.poehali.dev/projects/ae951cd8-f121-4577-8ee7-ada3d70ee89c/bucket/7w_ZeqXSou-w63TAv5UzA.png',
      icon: 'Palette',
      path: '/colortype',
    },
  ];
