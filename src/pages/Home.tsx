  ...
  const services = [
    {
      ...
      image: 'https://cdn.poehali.dev/projects/ae951cd8-f121-4577-8ee7-ada3d70ee89c/files/43210158-1027-4ed8-af4b-76272ee9b0ca.jpg',
      icon: 'Shirt',
      path: '/virtualfitting',
    },
    {
      ...
      image: 'https://cdn.poehali.dev/projects/ae951cd8-f121-4577-8ee7-ada3d70ee89c/files/cc2334d4-e288-47c3-a9a8-fb237655b62e.jpg',
      icon: 'Palette',
      path: '/colortype',
    },
  ];
          ...
          <div className="container mx-auto px-4 py-4">
            <nav className="flex items-center justify-between lg:justify-end">
              ...
              <Link to="/" className="absolute left-1/2 -translate-x-1/2 lg:static lg:translate-x-0 lg:mr-auto flex items-center hover:opacity-80 transition-opacity">
                <img src="https://cdn.poehali.dev/projects/ae951cd8-f121-4577-8ee7-ada3d70ee89c/bucket/logo-fitting-room-2.svg" alt="StyleSelect" className="h-8 md:h-10" />
              </Link>
              ...
              {user ? (
                <>
                  ...
                  <Button variant="outline" size="sm" onClick={handleLogout} className="hidden lg:flex text-white bg-transparent border-white/30 hover:bg-white/10 hover:border-white/50 hover:text-white">
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="mb-12">
              ...
              <p className="text-gray-300 text-lg">
                Fashion-платформа с технологиями ИИ. Подберите идеальный стиль за минуты.
              </p>
            </div>
