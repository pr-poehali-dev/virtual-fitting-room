        ...
        <div className="w-full mx-auto max-w-4xl">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-muted-foreground text-lg">
              ...
              желанию нейросеть составит промпт (задание на генерацию картинки) — и
                    ...
                    <div className="rounded-xl border border-purple-200 bg-purple-50 p-4">
                      <p className="flex items-start gap-2 text-sm text-gray-700">
                        ...
                        <span>
                          ...
                          нейросеть составить промпт (задание на генерацию
                          картинки) для любого изображения:
                      ...
                      <label className="flex items-start gap-3 cursor-pointer">
                        ...
                        <span>
                          <span className="block text-sm font-medium">
                            Нужен готовый промпт (задание на генерацию картинки)
                          </span>
          ...
          <FaqAccordion
            items={[
              ...
              },
              {
                ...
                answer:
                  "Да. Подсказки на странице написаны про моду, потому что это самый частый запрос, но сервис отвечает на вопросы любой темы и составит промпт (задание на генерацию картинки) под вашу задачу.",
              },
              {
                question: "Обязательно ли генерировать картинку?",
                answer: `Нет. Ответ и промпт (задание на генерацию картинки) вы получаете за ${CONSULT_COST} ₽ и можете этим ограничиться. Картинка рисуется только по кнопке и стоит ${GENERATION_COST} ₽.`,
              },
              {
