...
# Воркер отмечается каждые несколько секунд, пока модель пишет, поэтому
# долго ждать незачем. Чуть больше замка воркера (30 с), иначе побудка
# упрётся в замок вхолостую
WORKER_DEAD_SECONDS = 40
STALE_ERROR_MESSAGE = (
