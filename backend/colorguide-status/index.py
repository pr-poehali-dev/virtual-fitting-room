...
# Воркер отмечается на каждом крупном шаге, поэтому долго ждать не нужно.
# Чуть больше замка воркера (90 с), иначе побудка упрётся в замок вхолостую
WORKER_DEAD_SECONDS = 105
STALE_ERROR_MESSAGE = (
