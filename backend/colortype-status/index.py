...
AMBIGUOUS_COMBINATIONS = {
    ('WARM-UNDERTONE', 'MEDIUM-LIGHTNESS-COLORS', 'BRIGHT-NEUTRAL-SATURATION-COLORS', 'HIGH-MEDIUM-CONTRAST'): ['FIERY AUTUMN', 'VIBRANT SPRING'], 
    ('WARM-UNDERTONE', 'MEDIUM-LIGHTNESS-COLORS', 'BRIGHT-NEUTRAL-SATURATION-COLORS', 'LOW-MEDIUM-CONTRAST'): ['FIERY AUTUMN','BRIGHT SPRING'],
...
COLORTYPE_MAP = {
    ...
    ('COOL-UNDERTONE', 'LIGHT-COLORS', 'BRIGHT-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): 'SOFT SUMMER',
    ('COOL-UNDERTONE', 'MEDIUM-LIGHTNESS-COLORS', 'MUTED-NEUTRAL-SATURATION-COLORS', 'LOW-CONTRAST'): 'VIVID SUMMER',
    ...
    ('COOL-UNDERTONE', 'DEEP-COLORS', 'MUTED-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): 'VIVID SUMMER',
    ('COOL-UNDERTONE', 'LIGHT-COLORS', 'MUTED-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): 'DUSTY SUMMER',
    ('COOL-UNDERTONE', 'MEDIUM-LIGHTNESS-COLORS', 'MUTED-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): 'DUSTY SUMMER',
    ...
    ('WARM-UNDERTONE', 'LIGHT-COLORS', 'MUTED-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): 'GENTLE AUTUMN',
    ('WARM-UNDERTONE', 'LIGHT-COLORS', 'MUTED-SATURATION-COLORS', 'LOW-CONTRAST'): 'GENTLE AUTUMN',
    ('WARM-UNDERTONE', 'MEDIUM-LIGHTNESS-COLORS', 'MUTED-NEUTRAL-SATURATION-COLORS', 'LOW-MEDIUM-CONTRAST'): 'GENTLE AUTUMN',
    ...
    ('WARM-UNDERTONE', 'DEEP-COLORS', 'BRIGHT-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): 'FIERY AUTUMN',
    ('WARM-UNDERTONE', 'MEDIUM-LIGHTNESS-COLORS', 'BRIGHT-SATURATION-COLORS', 'LOW-MEDIUM-CONTRAST'): 'FIERY AUTUMN',
    ('WARM-UNDERTONE', 'DEEP-COLORS', 'MUTED-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): 'VIVID AUTUMN',
    ...
    ('WARM-UNDERTONE', 'LIGHT-COLORS', 'BRIGHT-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): 'BRIGHT SPRING',
...
def match_colortype(analysis: dict) -> tuple:
    ...
    for colortype in COLORTYPE_REFERENCES.keys():
        ...
        if colortype in excluded_types:
            print(f'[Match] Skipping {colortype} (excluded by color rule)')
            continue
