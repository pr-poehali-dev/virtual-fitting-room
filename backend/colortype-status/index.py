...
AMBIGUOUS_COMBINATIONS = {
    ('WARM-UNDERTONE', 'MEDIUM-LIGHTNESS-COLORS', 'BRIGHT-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): ['BRIGHT SPRING', 'FIERY AUTUMN', 'VIBRANT SPRING'], 
    ('WARM-UNDERTONE', 'MEDIUM-LIGHTNESS-COLORS', 'MUTED-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): ['GENTLE AUTUMN'],
    ('COOL-UNDERTONE', 'DEEP-COLORS', 'BRIGHT-NEUTRAL-SATURATION-COLORS', 'MEDIUM-CONTRAST'): ['VIVID WINTER', 'BRIGHT WINTER'],
