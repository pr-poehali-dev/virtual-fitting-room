...
PERSON — MOST IMPORTANT: take the person STRICTLY from the provided photo and keep their EXACT real face, facial features, face shape, eyes, nose, lips, eyebrows, skin tone and natural age in all three cells. Use their real appearance from the uploaded photo as the single source of truth — do NOT invent a new face, do NOT change ethnicity or age, do NOT reshape their features. It must clearly and recognizably be the SAME real person in every cell, photorealistic, not illustrated. You MAY only gently enhance them so they look their best: fresh, healthy, well-groomed skin and light natural makeup — but keep identity 100% intact. ONLY the HAIR changes between cells.
