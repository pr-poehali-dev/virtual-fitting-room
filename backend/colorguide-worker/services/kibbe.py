...
ШАГ 1. ДОМИНАНТА — строго по росту клиента из блока "РОСТ КЛИЕНТА". НЕ оценивай рост по фотографии.
- Рост 168 см и выше — доминанта ВЕРТИКАЛЬ, даже если изгибы хорошо заметны.
- Рост ниже 168 см — доминанта ИЗОГНУТАЯ.
...
Смотри на ОБЩУЮ линию силуэта целиком, а не на отдельные части тела. Не выбирай "средний" или "умеренный" вариант — выбери тот, что выражен сильнее всего.
...
ШАГ 4. ПРОВЕРЬ ПО СХЕМЕ: сопоставь линии фигуры клиента с силуэтом получившегося типажа на справочной схеме и убедись, что рост клиента укладывается в ростовые рамки этого типажа, указанные на схеме. Если силуэт клиента заметно ближе к другой карточке схемы — вернись к шагу 2 и перепроверь дополнительную линию.
