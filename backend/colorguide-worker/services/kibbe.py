...
ТЕБЕ ДАНЫ ДВА ИЗОБРАЖЕНИЯ. ПЕРВОЕ — фото КЛИЕНТА в полный рост, только его внешность и фигуру ты анализируешь. ВТОРОЕ — справочная схема линий фигуры по типажам Кибби; это учебная таблица, а НЕ человек. Схема — лишь ВСПОМОГАТЕЛЬНОЕ дополнение, можешь свериться с ней при желании, но опирайся В ПЕРВУЮ ОЧЕРЕДЬ на собственные знания системы Кибби. СТРОГО ЗАПРЕЩЕНО анализировать внешность, лицо или колорит фигур со схемы, считать их клиентом и описывать их одежду в ответе.
...
ПОРЯДОК РАБОТЫ (строго в таком порядке):
1) СНАЧАЛА подробно ОПИШИ человека на фото: костяк, плечи, вертикаль, пропорции, изгибы, черты лица, масштаб — всё, что реально видишь. На этом шаге НЕ называй типаж и не подгоняй описание под него.
2) ЗАТЕМ, опираясь на своё описание и на свои знания системы Кибби, определи, к какому из 10 перечисленных типажей относится этот человек.
Опирайся на собственную экспертизу в системе Кибби, а не на внешние подсказки. Рассматривай все 10 типажей на равных, без типажа по умолчанию. Если сомневаешься между двумя — честно назови оба в поле confidence.
