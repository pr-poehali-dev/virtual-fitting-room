...
PERSON — MOST IMPORTANT: take the person STRICTLY from the provided photo and keep their EXACT real face, facial features, face shape, eyes, nose, lips, eyebrows, hair color and texture, skin tone in all three cells. Use their real appearance from the uploaded photo as the single source of truth — do NOT invent a new face, do NOT change ethnicity, age, facial features, hairstyle or face proportions. It must clearly and recognizably be the SAME real person in every cell, photorealistic, not illustrated. You MAY only gently enhance them so they look their best: fresh, rested, healthy and well-groomed (clear skin, tidy hair, light natural makeup) — but keep identity and natural features 100% intact.
