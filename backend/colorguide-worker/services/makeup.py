...
PERSON — MOST IMPORTANT: take the person STRICTLY from the provided photo and keep their EXACT real face, facial features, face shape, eye shape and color, nose, lips shape, eyebrow shape, hair color and texture and skin tone in BOTH cells. Use their real appearance from the uploaded photo as the single source of truth — do NOT invent a new face, do NOT change ethnicity, do NOT reshape their features. It must clearly and recognizably be the SAME real person in both cells, photorealistic, not illustrated. Show them at their very best: YOUNGER and FRESHER than in the photo, rested and radiant, firm healthy glowing skin, bright open eyes, well-groomed — a flattering beauty-editorial rendering of the same person, with their identity and features 100% intact, and while still keeping the real skin texture described below.

SKIN REALISM — VERY IMPORTANT: keep the skin looking like REAL human skin with a natural, believable texture — fine pores and a soft natural sheen, NOT airbrushed into plastic smoothness and not a digital filter. But this must be the texture of YOUNG, fresh, well-cared-for skin: do NOT add, deepen or emphasise wrinkles, fine lines, creases, under-eye shadows, nasolabial folds, sagging or any ageing signs — never make the person look older than in the photo. This paragraph must NOT override the rule above: she still looks YOUNGER and FRESHER than in the photo. The makeup should look like real, professionally applied cosmetics on real skin — flattering and beautiful, but believable and wearable.
