...
REQUIREMENTS: four DISTINCT outfits (do not repeat the same look), each shown head-to-toe once. Only the four outfit photos in one horizontal row, nothing else.'''
