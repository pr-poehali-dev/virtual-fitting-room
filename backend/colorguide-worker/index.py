...
КРИТИЧЕСКИ ВАЖНО — соответствие НАЗВАНИЯ цвета и его HEX-кода:
Названия и hex-коды должны соответствовать друг другу визуально. Если в названии «розовый» — hex обязан быть в розовой/малиновой гамме. Если в названии «синий» — hex синий. Это касается ВСЕХ цветов в ответе.

ДЛЯ hair_colors (цвета волос) ИСПОЛЬЗУЙ ТОЛЬКО эти диапазоны:
Волосы бывают ТОЛЬКО в коричнево-бежево-русо-каштаново-чёрно-рыже-седой гамме. ЗАПРЕЩЕНО давать зелёный, синий, фиолетовый, серо-зелёный hex в hair_colors — это БАГ.

Примеры правильных hex для волос:
- Платиновый блонд: #E8DCC4, #EFE5D1
- Светло-русый: #C9B59A, #B8A082, #A99770
- Тёмно-русый: #8B7355, #7A6647
- Пепельно-русый: #A89E8C, #9C9486, #8E8676 (СЕРОВАТО-БЕЖЕВЫЙ, НЕ зелёный!)
- Холодный блонд: #D4C8B0, #C8BCA0
- Шатен светлый: #6F4E37, #7A5230
- Шатен холодный: #5C4033, #4A3528
- Шатен тёплый/каштановый: #8B4513, #964B00
- Тёмный шатен: #3E2723, #2F1B14
- Чёрный: #1A1A1A, #0F0F0F
- Холодный чёрный: #1C1B1F
- Медный/рыжий: #B7410E, #A0522D, #CD853F
- Тёмно-рыжий: #8B3A1F, #7B2D0E
- Светло-рыжий: #D2691E, #CD7F32
- Седой/серебристый: #B8B5B0, #A8A5A0

Если ты пишешь название «русый» — hex ОБЯЗАН быть в диапазоне #8B7355…#C9B59A (бежево-коричневый).
Если ты пишешь «пепельный» — hex обязан быть серо-бежевым (например, #A89E8C), а НЕ серо-зелёным.
Если ты пишешь «шоколадный» / «каштановый» — hex в коричневой гамме (#3E2723…#8B4513).

ПЕРЕД отдачей ответа МЫСЛЕННО проверь каждый hex волос: представь этот цвет — это похоже на цвет реальных человеческих волос? Если нет — поменяй hex.
'''
