...
def match_colortype(analysis: dict, gpt_suggested_type: str = None) -> tuple:
    ...
    for colortype in stage2_candidates:
        ...
        # BONUS: Auburn/copper/red hair + brown eyes → +0.40 for FIERY AUTUMN (signature combination)
        if has_auburn_hair and has_brown_eyes and colortype == 'FIERY AUTUMN':
            color_score += 0.40
            print(f'[Match] {colortype}: BONUS +0.40 for auburn hair + brown eyes (signature FIERY AUTUMN)')
