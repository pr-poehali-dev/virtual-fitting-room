...
AMBIGUOUS_COMBINATIONS = {
    ...
    ('WARM-UNDERTONE', 'BRIGHT-SATURATION-COLORS', 'LOW-MEDIUM-CONTRAST'): ['FIERY AUTUMN', 'BRIGHT SPRING', 'GENTLE SPRING', 'VIVID AUTUMN'],
}
...
COLORTYPE_REFERENCES = {
    ...
    'VIVID AUTUMN': {
        ...
        'eyes': ['brown', 'brown-green', 'dark brown', 'chocolate'],
    ...
    'GENTLE SPRING': {
        ...
        'eyes': ['blue', 'blue-green', 'light blue', 'light blue-green', 'light green', 'light turquoise'],
    ...
    'VIBRANT SPRING': {
        ...
        'eyes': ['blue-green', 'blue', 'green', 'golden brown', 'bright', 'bright brown', 'bright blue', 'bright brown-green', 'bright green', 'bright blue-green'],
    ...
    'BRIGHT WINTER': {
        ...
        'eyes': ['brown', 'blue', 'brown-green', 'green', 'gray', 'dark', 'bright brown', 'bright blue', 'bright brown-green', 'bright green', 'bright gray-blue'],
    ...
    'DUSTY SUMMER': {
        'hair': ['medium cool blond', 'deep cool blond', 'light ash blonde', 'medium ash blonde', 'light cool brown', 'medium cool brown', 'ash brown', 'medium ash brown'],
...
COLORTYPE_MAP = {
    ...
    ('COOL-UNDERTONE', 'MUTED-SATURATION-COLORS', 'LOW-CONTRAST'): 'DUSTY SUMMER',
    ('COOL-UNDERTONE', 'MUTED-SATURATION-COLORS', 'HIGH-MEDIUM-CONTRAST'): 'DUSTY SUMMER',
    ...
    ('WARM-UNDERTONE', 'MUTED-NEUTRAL-SATURATION-COLORS', 'HIGH-MEDIUM-CONTRAST'): 'GENTLE AUTUMN',
