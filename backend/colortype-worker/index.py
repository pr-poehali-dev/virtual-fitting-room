...
AMBIGUOUS_COMBINATIONS = {
    ...
    ('COOL-UNDERTONE', 'MUTED-SATURATION-COLORS', 'HIGH-MEDIUM-CONTRAST'): ['DUSTY SUMMER', 'VIVID SUMMER'],
    ('COOL-UNDERTONE', 'BRIGHT-NEUTRAL-SATURATION-COLORS', 'HIGH-MEDIUM-CONTRAST'): ['VIVID SUMMER', 'BRIGHT WINTER'],
