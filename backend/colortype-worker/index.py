            ...
            if not replicate_prediction_id:
                ...
                try:
                    ...
                    if is_image_fetch_error:
                        user_msg = 'Не удалось загрузить ваше фото для анализа. Деньги вернутся на баланс автоматически сразу или чуть позже администратором. Пожалуйста, попробуйте ещё раз.'
                    elif is_timeout:
                        user_msg = 'Анализ занял слишком много времени. Деньги вернутся на баланс автоматически сразу или чуть позже администратором. Попробуйте позже.'
                    else:
                        user_msg = 'Ошибка сервиса анализа. Деньги вернутся на баланс автоматически сразу или чуть позже администратором. Попробуйте позже.'
